...
int compare2(struct PokerHand o1, struct PokerHand o2) {
  ...
  if (higherTriple == lastIndexOf(o2,3)) {
	...
	return 0;
      ...
      if ((i2 != higherTriple) && ((charAt(o1,i2) == 2) || (charAt(o1,i2) == 3))) { // only c1 Full house
	return -1;
      }
      if ((i2 != higherTriple) && ((charAt(o2,i2) == 2) || (charAt(o2,i2) == 3))) { // only c2 Full house
	return 1;
      }
      //Not in the original Java source code
      i2++;
    }
  }
