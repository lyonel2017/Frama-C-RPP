...
val get_typ_in_current_project:
  Cil_types.typ -> Cil.visitor_behavior -> Lexing.position -> Cil_types.typ

val sorter :
  ('a * 'b) list -> 'a list * 'b list

val id_convert:
  string -> Lexing.position -> Rpp_types.call_data list -> Cil_types.logic_builtin_label
...
val function_return_type:
  Cil_types.varinfo -> Cil.visitor_behavior -> Lexing.position -> Cil_types.typ

val make_local:
  Cil_types.fundec ->
  Cil_types.fundec ->
  int -> Cil.visitor_behavior ->
  Lexing.position -> int ->
...
val make_unique_gloable_name:
  ?acc:int -> String.t ->
  Cil_types.varinfo list -> String.t
...
class separate_checker:
  Lexing.position -> Cil_types.term list ->
